...
/obj/item/seeds/poppy/lily/trumpet
	...
	desc = "A plant sculped by extensive genetic engineering. The spaceman's trumpet is said to bear no resemblance to its wild ancestors. Inside GATO AgriSci circles it is better known as NTPW-0372."
