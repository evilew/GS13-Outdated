...
/obj/item/storage/daki
	...
	var/cooldowntime = 20
	var/static/list/dakimakura_options = list("Callie","Camille","Casca","Chaika","Elisabeth","FoxyGrandpa","Haruko","Holo","Ian","Jolyne","Kurisu","Marie","Mugi","Nar'Sie","Patchouli","Plutia","Rei","Reisen","Naga","Squid","Squigly","SueBowchief","Sussy","Tomoko","Toriel","Umaru","Yaranaika","Yoko","Fatty") //Kurisu is the ideal girl." - Me, Logos.
