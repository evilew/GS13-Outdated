...
/obj/machinery/computer/reactor/fuel_rods/attack_hand(mob/living/user)
	...
	if(!fuel_rod)
		return
	playsound(src, pick('hyperstation/sound/effects/rbmk/switch.ogg','hyperstation/sound/effects/rbmk/switch2.ogg','hyperstation/sound/effects/rbmk/switch3.ogg'), 100, FALSE)
	playsound(reactor, 'hyperstation/sound/effects/ship/freespace2/crane_1.wav', 100, FALSE)
...
/obj/machinery/computer/reactor/pump/attack_hand(mob/living/user)
	...
	if(!is_operational())
		return FALSE
	playsound(loc, pick('hyperstation/sound/effects/rbmk/switch.ogg','hyperstation/sound/effects/rbmk/switch2.ogg','hyperstation/sound/effects/rbmk/switch3.ogg'), 100, FALSE)
...
/obj/effect/decal/nuclear_waste
	...
	icon = 'hyperstation/icons/obj/machinery/reactor_parts.dmi'
...
/datum/weather/nuclear_fallout
	...
	weather_sound = 'hyperstation/sound/effects/ship/reactor/falloutwind.ogg'
	end_duration = 100
	area_type = /area
...
/obj/item/sealant
	...
	icon = 'hyperstation/icons/obj/inflatable.dmi'
	icon_state = "sealant"
	w_class = 1
