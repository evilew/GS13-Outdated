...
/obj/item/autosurgeon/nutripump_turbo
	desc = "A single use autosurgeon that contains a turbo version of nutriment pump augment. A screwdriver can be used to remove it, but implants can't be placed back in."
	uses = 1
